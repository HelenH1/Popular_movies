...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        String posterPath = mBasicMovieInfo[position].getAsString("movie_poster_path");
        //System.out.println("Poster path: "+posterPath);
        String movieURLExt = posterPath;
    ...
    class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ForecastAdapterViewHolder(View view) {
            ...
            iconView = (ImageView) view.findViewById(R.id.iv_movie_poster_main);
